...
import { useGetTreamentTypeQuery } from "@/Redux/features/Appointment/Calendar/CalendarApi";
import { useGetAppointmentPOSQuery } from "@/Redux/features/Appointment/appointmentApi";
import axios from "axios";

const CalenderFilter = ({token, startdate, enddate, setFilterValue}) => {  
  ...
  const { data: treamentData, isLoading: treatmentLoading } =
  ...
  useEffect(() => {
    const getPatientsData = async () => {
      const res = await axios({
        method: "GET",
        url: `${process.env.NEXT_PUBLIC_ADMIN_URL}/appointment/patients/list`,
        headers: {
  ...
  useEffect(() => {
    const getProviderData = async () => {
      ...
      const res = await axios({
        method: "GET",
        url: `${process.env.NEXT_PUBLIC_ADMIN_URL}/appointment/provider/list`,
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          "Authorization": token || null,
  ...
  useEffect(() => {
    const getServiceData = async () => {
      ...
      const res = await axios({
        method: "POST",
        url: `${process.env.NEXT_PUBLIC_ADMIN_URL}/appointment/non-billable/service`,
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          "Authorization": token || null,
