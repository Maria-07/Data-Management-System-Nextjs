    ...
    <div className="py-5 min-h-[80vh]">
      <div className="flex justify-between">
        ...
        <div className="mb-10 flex items-center justify-end gap-3">
          <div className="">
            <button className="bg-primary mb-3 w-[255px] transition-all hover:bg-secondary flex items-center gap-2 text-white px-3 py-1 rounded-md shadow-md">
              <BiVideo className="text-xl" /> UPLOAD INSTRUCTION VIDEO
            </button>
            <button className="bg-gray-500 transition-all hover:bg-dark flex items-center gap-2 text-white px-3 py-1 rounded-md shadow-md">
