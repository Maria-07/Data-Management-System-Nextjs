        ...
        <div>
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-4 items-center">
                    ...
                    />
                    <span className="label-text-alt">
                      {(errors.new_password?.type === "required" || errors.new_password?.type === "minLength" ) && (
                        <p className=" text-xs text-red-500 pl-1 pt-[1px]">
                    ...
                    <div>
                    <label className="label">
                        <span className=" label-font">Confirm Password<span className="text-red-500">*</span></span>
                    </label>
                    <input
                        type="password"
                        className="input-border-bottom input-font py-[1px] w-full focus:outline-none"
                    ...
                    />                    
                    <span className="label-text-alt">
                    {(errors.confirm_password?.type === "required" || errors.new_password?.type === "minLength") && (
                        <p className=" text-xs text-red-500 pl-1 pt-[1px]">
