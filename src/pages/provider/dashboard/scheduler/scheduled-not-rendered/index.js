...
const ScheduleNotAttendedLastWeek = () => {
      ...
      <div className="flex justify-between">
        <div>
          <h1 className="text-orange-500 font-medium text-base mb-3">
            Schedule Not Attended Last Week
          </h1>
        </div>
        <div className="mr-2">
...
export default ScheduleNotAttendedLastWeek;

ScheduleNotAttendedLastWeek.getLayout = function getLayout(page) {
