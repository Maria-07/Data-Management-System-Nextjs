  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, { wait_list }) => {
        ...
        return <div className="flex justify-center text-primary">Active</div>;
      },
    },
    {
      title: "Supervisor",
            ...
            <div className="flex items-center gap-4">
              <div>
                <label className="label">
                  <span className="label-font">Select Interval</span>
                </label>
                <select
                  {...register("interval")}
              ...
              <button
                className=" border-secondary flex items-center border rounded-sm mt-5
              "
              >
...
AuthExpired.getLayout = function getLayout(page) {
