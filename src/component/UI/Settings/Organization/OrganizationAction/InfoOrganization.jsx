...
const InfoOrganization = () => {
  ...
  return (
    <div>
      <form>
        <div className="flex items-center justify-center text-primary border border-primary transition-all hover:bg-secondary hover:text-white py-[2px] rounded-md">
          <button
            type="button"
